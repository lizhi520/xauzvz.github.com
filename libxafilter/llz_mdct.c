...
typedef struct _llz_mdct_ctx_t {
    ...
    void    (*mdct_func)(struct _llz_mdct_ctx_t *f, const float *x, float *X, int N);
    void    (*imdct_func)(struct _llz_mdct_ctx_t *f, const float *X, float *x, int N2);
...
int llz_mdct_sine(float *w, int N)
{
    float tmp;
    int   n;
...
int llz_mdct_kbd(float *w, int N, float alpha)
{
    int i,j;
    int N2;
    float *w1;
...
static void mdct0(llz_mdct_ctx_t *f, const float *x, float *X, int N)
{
    int k, n;
    int N2;
...
static void imdct0(llz_mdct_ctx_t *f, const float *X, float *x, int N2)
{
    int n, k;
    int N;
...
static void mdct1(llz_mdct_ctx_t *f, const float *x, float *X, int N)
{
    int k;
    int N2;
...
static void imdct1(llz_mdct_ctx_t *f, const float *X, float *x, int N2)
{
    int k, i;
    int N;
...
static void mdct2(llz_mdct_ctx_t *f, const float *x, float *X, int N)
{
    int k;
    int N2;
    int N4;
...
static void imdct2(llz_mdct_ctx_t *f, const float *X, float *x, int N2)
{
    int k;
    int N;
    int N4;
...
void llz_mdct(uintptr_t handle, float *x, float *X)
{
    llz_mdct_ctx_t *f = (llz_mdct_ctx_t *)handle;
...
void llz_imdct(uintptr_t handle, float *X, float *x)
{
    llz_mdct_ctx_t *f = (llz_mdct_ctx_t *)handle;
